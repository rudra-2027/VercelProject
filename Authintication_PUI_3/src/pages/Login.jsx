...
export default function Login() {
  ...
  return (
    /* ⭐ NEW MAIN PARENT WRAPPER */
    <div className="main-auth-wrapper w-full min-h-screen flex items-center justify-center bg-black">

      {/* Existing outer container */}
      <div className="flex items-center h-full w-full justify-center mt-10 p-6 bg-gradient-to-b from-[#0b0b0b] to-[#0a0a0a]">
